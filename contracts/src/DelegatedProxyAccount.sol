...
import "@account-abstraction@v0.7.0/samples/SimpleAccount.sol";
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";
import "@openzeppelin/contracts/utils/cryptography/MessageHashUtils.sol";
import "./TargetBase.sol";

/**
 * @title DelegatedProxyAccount
 * @notice EIP-4337 smart account with delegate authorization and ETH fee collection
 * @dev Extends SimpleAccount with delegate signature validation and fee management
 */
contract DelegatedProxyAccount is SimpleAccount {
     ...
     * @param feeRecipient Address to receive ETH fees
    ...
    /**
     * @notice Initialize with EntryPoint
     */
    ...
    /**
     * @notice Initialize account with delegate and fee settings
     ...
     */
    function initializeWithConfig(AccountConfig calldata config) public virtual initializer {
        ...
        external
    {
        ...
        if (feeSponsored) {
            ...
            emit FeeSponsoredByMasterKey(feeRecipient, ethFee);
        } else {
            ...
            if (ethFee > 0 && feeRecipient != address(0)) {
                ...
                emit FeeTransferred(feeRecipient, ethFee);
            }
        }
        ...
        returns (uint256 validationData)
    {
        ...
        if (hash.recover(userOp.signature) == delegate) {
